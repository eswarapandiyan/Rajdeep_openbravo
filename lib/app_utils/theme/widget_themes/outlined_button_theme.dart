...
class WOutlinedButtonTheme {
  ...
  static final lightOutlinedButtonTheme = OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      textStyle: const TextStyle(
          fontSize: 16, color: WColors.black, fontWeight: FontWeight.w600),
      padding: const EdgeInsets.symmetric(
          vertical: WSizes.buttonHeight, horizontal: 20),
  ...
  static final darkOutlinedButtonTheme = OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      side: const BorderSide(color: WColors.borderPrimary),
      textStyle: const TextStyle(
          fontSize: 16, color: WColors.textWhite, fontWeight: FontWeight.w600),
      padding: const EdgeInsets.symmetric(
          vertical: WSizes.buttonHeight, horizontal: 20),
      shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(WSizes.buttonRadius)),
